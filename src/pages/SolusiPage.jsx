    ...
    <div className="bg-brand-bg min-h-screen relative overflow-hidden flex flex-col justify-start pt-20">
      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-16 w-full relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16 md:mb-24">
        ...
        <div className="space-y-6 text-center md:text-left">
          ...
          <p className="text-brand-dark/70 font-sans font-medium text-sm lg:text-base leading-relaxed max-w-[420px] mx-auto md:mx-0">
        ...
        <div className="relative flex justify-center lg:justify-end items-center mt-8 md:mt-0">
          <img 
            ...
            className="w-full max-w-[320px] lg:max-w-[450px] object-contain z-10"
          />
        </div>
      </div>
        ...
        <div className="relative px-12 md:px-20">
          ...
          >
            ...
            {solutions.map((item, idx) => (
              <div 
                key={idx}
                className="w-full md:w-[calc(50%-0.75rem)] flex-none snap-start bg-white rounded-[24px] p-4 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-brand-gray/30 flex flex-col h-full"
              >
                {/* Image & Badge */}
                <div className="relative rounded-[16px] overflow-hidden h-48 md:h-52 mb-5">
                ...
                <div className="flex flex-col flex-grow px-1 pb-1">
                  ...
                  <p className="font-sans text-brand-dark/70 text-[13px] md:text-sm leading-relaxed mb-6 flex-grow font-medium">
                    {item.description}
                  </p>

                  {/* Button */}
                  <button className="w-full py-3 rounded-xl border border-brand-orange text-brand-orange bg-white font-sans font-bold text-sm hover:bg-brand-orange hover:text-white transition-all flex items-center justify-center gap-2 mt-auto">
