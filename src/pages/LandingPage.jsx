...
import laptopMejaImg from '../assets/images/ilustrasi-meja-laptop.svg';
    ...
    return (
        <div className="bg-brand-bg min-h-screen text-brand-dark font-sans overflow-hidden pt-12">
            ...
            <section className="relative pt-12 pb-8 overflow-hidden">
                ...
                {/* Kontainer Atas: Teks & Gambar Jendela */}
                <div className="max-w-7xl mx-auto px-8 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center z-10 relative">
                    ...
                    <div className="relative flex justify-center lg:justify-end">
                        <img
                            ...
                            className="w-full max-w-lg lg:max-w-xl object-contain drop-shadow-sm"
                        />
                    </div>
                </div>

                {/* Kontainer Bawah: Gambar Meja */}
                <div className="w-full mt-20 md:mt-24 relative left-0 right-0">
                    <img
                        src={laptop}
            ...
            <section className="py-16 px-8 max-w-7xl mx-auto text-center relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Card 1 */}
                    <div className="bg-white rounded-3xl p-8 shadow-xs border border-gray-100 flex flex-col items-center text-center space-y-4 hover:shadow-md transition">
            ...
            <section className="py-20 px-8 max-w-7xl mx-auto text-center">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-6 relative">
                    {/* Card 1 */}
                    <div className="bg-white rounded-3xl p-8 shadow-xs border border-gray-100 flex-1 w-full flex flex-col items-center justify-between min-h-[460px] text-center">
            ...
            <section className="py-24 px-8 max-w-5xl mx-auto space-y-12">
                ...
                <div className="space-y-5">
                    {faqs.map((faq, index) => (
                        <div key={index} className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-xs">
                            <button
                                onClick={() => toggleFaq(index)}
                                className="w-full text-left p-6 flex justify-between items-center font-sans font-bold text-base md:text-lg text-gray-700 hover:bg-gray-50 transition"
                            >
                                <div className="flex items-center gap-4">
                                    <span className="bg-brand-green/20 text-brand-green text-sm w-8 h-8 rounded-xl flex items-center justify-center font-bold">
                                        0{index + 1}
                                    </span>
                                    {faq.q}
                                </div>
                                <span className="text-brand-green text-2xl font-extrabold ml-4">{openFaq === index ? '−' : '+'}</span>
                            </button>
                            {openFaq === index && (
                                <div className="p-6 pt-0 font-sans text-sm md:text-base text-gray-500 border-t border-gray-50 leading-relaxed">
                                    {faq.a}
                                </div>
                            )}
                        </div>
            ...
            {/* 6. BANNER KONTAK */}
            <section className="pt-12 pb-52 px-8 max-w-5xl mx-auto relative z-10">
