...
export default function CekKondisiFormPage() {
  ...
  const steps = [
    ...
    { num: 4, title: "Hasil Rekomendasi", desc: "Detail tentang lokasi" },
  ];
  ...
  const handleNext = () => {
    if (currentStep === 3) {
      ...
      console.log("DEV ONLY - Engine Result:", result);
      setCurrentStep(4);
    ...
    <div className="bg-brand-bg min-h-screen relative overflow-hidden flex flex-col justify-start pt-8 pb-48 md:pb-64 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full relative z-10 flex flex-col items-center">
        ...
        <div className="w-full max-w-5xl flex flex-col lg:flex-row gap-8 items-start">
          ...
          {/* Left Column: Form */}
          <div className="w-full lg:w-2/3 bg-white rounded-[32px] p-8 md:p-10 shadow-sm flex flex-col gap-10">
            
            {/* ==================== SESI 1 ==================== */}
            {currentStep === 1 && (
              <div>
                <div className="inline-block bg-[#F2FBE9] text-brand-green font-bold text-xs px-4 py-2 rounded-full mb-6 w-fit self-start">
                  Pertanyaan 1
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <RadioOption 
                    icon={<img src={rumahIcon} className="w-8 h-8 object-contain" alt="Rumah" />} 
                    label="Rumah" desc="Halaman taman atau area sekitar rumah." 
                    value="home" selectedValue={locationType} onChange={setLocationType} 
                  />
                  <RadioOption 
                    icon={<img src={perkantoranIcon} className="w-8 h-8 object-contain" alt="Perkantoran" />} 
                    label="Perkantoran" desc="Area kantor atau gedung komersial." 
                    value="office" selectedValue={locationType} onChange={setLocationType} 
                  />
                  <RadioOption 
                    icon={<img src={sekolahIcon} className="w-8 h-8 object-contain" alt="Sekolah" />} 
                    label="Sekolah / Kampus" desc="Taman belajar atau lapangan sekolah." 
                    value="school" selectedValue={locationType} onChange={setLocationType} 
                  />
                  <RadioOption 
                    icon={<img src={ruangPublikIcon} className="w-8 h-8 object-contain" alt="Ruang Publik" />} 
                    label="Ruang Publik" desc="Taman, ruang terbuka dan lainnya." 
                    value="public_space" selectedValue={locationType} onChange={setLocationType} 
                  />
                  
                  {/* Lainnya Option */}
                  <label 
                    className={`flex items-center gap-4 p-4 rounded-2xl border-2 cursor-pointer transition-all
                      ${locationType === 'other' ? 'border-brand-green bg-[#F9FDF5]' : 'border-brand-gray/30 hover:border-brand-gray/60 bg-white'}`}
                  >
                    <input 
                      type="radio" 
                      name="locationType"
                    ...
                    <div className="flex flex-col grow gap-2 w-full">
                      ...
                      <input 
                        ...
                        onChange={(e) => {
                          ...
                          setCustomLocationType(e.target.value);
                        }}
                        onClick={(e) => {
                        ...
                        className={`w-full bg-white border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 transition-colors
                          ${locationType === 'other' ? 'border-brand-green focus:ring-brand-green' : 'border-brand-gray/40'}`}
                      />
                    </div>
                  </label>
                </div>
            ...
            {currentStep === 2 && (
              <div className="space-y-12">
                ...
                {/* Q2 */}
                <div>
                  <div className="inline-block bg-[#F2FBE9] text-brand-green font-bold text-xs px-4 py-2 rounded-full mb-4 w-fit">Pertanyaan 2</div>
                  ...
                  <div className="space-y-3">
                    ...
                    {/* Area Lainnya */}
                    <label className={`flex items-center gap-4 p-4 rounded-2xl border-2 cursor-pointer transition-all ${areaType === 'other' ? 'border-brand-green bg-[#F9FDF5]' : 'border-brand-gray/30 hover:border-brand-gray/60 bg-white'}`}>
                      <input 
                        type="radio" 
                        name="areaType"
                        value="other"
                        checked={areaType === 'other'}
                        onChange={() => setAreaType('other')}
                        className="hidden" 
                      />
                      <div className="flex flex-col grow gap-2 w-full">
                ...
                {areaType === 'wall_fence' && (
                  <div className="bg-brand-gray/10 p-6 rounded-2xl border border-brand-gray/20">
                ...
                {/* Q3 */}
                <div>
                  <div className="inline-block bg-[#F2FBE9] text-brand-green font-bold text-xs px-4 py-2 rounded-full mb-4 w-fit">Pertanyaan 3</div>
                ...
                {/* Q4 */}
                <div>
                  <div className="inline-block bg-[#F2FBE9] text-brand-green font-bold text-xs px-4 py-2 rounded-full mb-4 w-fit">Pertanyaan 4</div>
                ...
                {/* Q5 */}
                <div>
                  <div className="inline-block bg-[#F2FBE9] text-brand-green font-bold text-xs px-4 py-2 rounded-full mb-4 w-fit">Pertanyaan 5</div>
                ...
                {/* Q6 */}
                <div>
                  <div className="inline-block bg-[#F2FBE9] text-brand-green font-bold text-xs px-4 py-2 rounded-full mb-4 w-fit">Pertanyaan 6</div>
                ...
                {/* Q7 */}
                <div>
                  <div className="inline-block bg-[#F2FBE9] text-brand-green font-bold text-xs px-4 py-2 rounded-full mb-4 w-fit">Pertanyaan 7</div>
                ...
                {/* Q8 */}
                <div>
                  <div className="inline-block bg-[#F2FBE9] text-brand-green font-bold text-xs px-4 py-2 rounded-full mb-4 w-fit">Pertanyaan 8</div>
                  <h2 className="text-xl font-header text-brand-dark mb-2">Kemampuan Perawatan</h2>
                  <p className="text-brand-dark/70 text-sm mb-4">Seberapa sering kamu dapat merawat area hijau tersebut? Pilih yang paling sesuai dengan waktu dan kemampuanmu.</p>
                  ...
                  <div className="space-y-3">
                    ...
                    <RadioOption label="Saya membutuhkan solusi dengan perawatan minimal" value="minimal" selectedValue={maintenanceFrequency} onChange={setMaintenanceFrequency} />
                  </div>
                </div>
            ...
            {currentStep === 3 && (
              <div className="space-y-12">
                <div>
                  <div className="inline-block bg-[#F2FBE9] text-brand-green font-bold text-xs px-4 py-2 rounded-full mb-4 w-fit">Pertanyaan Terakhir</div>
                  ...
                  <div className="space-y-3">
                    <CheckboxOption 
                      label="Membuat area lebih sejuk" desc="Membantu mengurangi rasa panas di sekitar area." 
                      value="cooler_area" selectedValues={goals} onChange={toggleGoal} maxAllowed={3} 
                    />
                    <CheckboxOption 
                      label="Menambah ruang hijau" desc="Membuat lingkungan memiliki lebih banyak tanaman." 
                      value="more_green_space" selectedValues={goals} onChange={toggleGoal} maxAllowed={3} 
                    />
                    <CheckboxOption 
                      label="Menambah keteduhan" desc="Menciptakan area yang lebih teduh dari paparan matahari." 
                      value="more_shade" selectedValues={goals} onChange={toggleGoal} maxAllowed={3} 
                    />
                    <CheckboxOption 
                      label="Mengurangi genangan air" desc="Membantu meningkatkan penyerapan air hujan." 
                      value="reduce_puddles" selectedValues={goals} onChange={toggleGoal} maxAllowed={3} 
                    />
                    <CheckboxOption 
                      label="Mempercantik area" desc="Membuat lingkungan terlihat lebih hijau dan menarik." 
                      value="beautification" selectedValues={goals} onChange={toggleGoal} maxAllowed={3} 
                    />
                    <CheckboxOption 
                      label="Memanfaatkan area kosong" desc="Mengubah ruang yang belum dimanfaatkan menjadi area hijau." 
                      value="use_empty_space" selectedValues={goals} onChange={toggleGoal} maxAllowed={3} 
                    />
                  </div>
                  
                  {goals.length === 3 && (
                    <p className="text-brand-orange font-bold text-xs mt-4 text-center bg-orange-50 py-2 rounded-lg">
                      Kamu sudah memilih maksimal 3 tujuan.
                    </p>
                  )}
                </div>
              </div>
            ...
            {currentStep === 4 && recommendationResult && (
              <div className="space-y-8 max-w-4xl mx-auto pt-6">
                ...
                {recommendationResult.primary ? (
                  <div className="bg-white rounded-3xl p-8 md:p-12 border border-gray-100 shadow-sm hover:shadow-lg transition-shadow duration-500 grid grid-cols-1 md:grid-cols-12 gap-8 items-start group">
                    <div className="md:col-span-7 space-y-6">
                      ...
                      <div className="flex items-center gap-4 pt-4 flex-wrap">
                        ...
                        <button 
                          ...
                          className="px-6 py-3 border border-red-200 text-red-600 rounded-xl hover:bg-red-50 text-sm font-medium transition flex items-center gap-2"
                        >
                ...
                {recommendationResult.conditionalSuggestions && recommendationResult.conditionalSuggestions.length > 0 && (
                  <div className="pt-8">
                    <h3 className="text-xl font-bold text-brand-dark mb-4 px-2">
                      Solusi Potensial — Perlu Verifikasi
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Navigation Buttons */}
            {currentStep < 4 && (
              <div className="flex justify-between items-center mt-auto pt-8 border-t border-brand-gray/10">
                <button 
                  onClick={handleBack}
                  className="flex items-center gap-2 px-6 py-3 border-2 border-brand-orange text-brand-orange bg-white rounded-xl font-bold text-sm hover:bg-orange-50 transition-colors"
                >
                ...
                <button 
                  ...
                  className={`flex items-center gap-2 px-8 py-3 rounded-xl font-bold text-sm transition-colors
                    ${isNextDisabled() ? 'bg-gray-300 text-gray-500 cursor-not-allowed' : 'bg-brand-orange text-white hover:bg-[#e87f2e]'}`}
                >
                  {currentStep === 3 ? "Lihat Rekomendasi" : "Lanjut"} <span>&rarr;</span>
                </button>
              </div>
            )}
          ...
          <div className="w-full lg:w-1/3 flex flex-col gap-6 sticky top-28">
            ...
            {/* Tips Card */}
            <div className="bg-[#FFFDF9] border border-brand-gray/20 rounded-3xl p-6 shadow-sm">
              <h3 className="font-bold text-brand-dark text-lg mb-6">Tips Sebelum Menjawab</h3>
              
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 shrink-0 flex items-center justify-center">
                    <img src={tanamanIcon} alt="Jawab sesuai kondisi" className="w-8 h-8 object-contain" />
                  </div>
                  <div>
                    <h4 className="font-bold text-brand-dark text-sm mb-1">Jawab sesuai kondisi</h4>
                    <p className="text-brand-dark/60 text-xs leading-relaxed">Berikan jawaban berdasarkan kondisi area saat ini.</p>
                  </div>
                </div>
                
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 shrink-0 flex items-center justify-center">
                    <img src={smileIcon} alt="Tidak ada jawaban salah" className="w-8 h-8 object-contain" />
                  </div>
                  <div>
                    <h4 className="font-bold text-brand-dark text-sm mb-1">Tidak ada jawaban salah</h4>
                    <p className="text-brand-dark/60 text-xs leading-relaxed">Semua jawaban akan membantu kami memberikan solusi terbaik.</p>
                  </div>
                </div>

                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 shrink-0 flex items-center justify-center">
                    <img src={checkJawabanIcon} alt="Periksa kembali jawaban" className="w-8 h-8 object-contain" />
                  </div>
                  <div>
                    <h4 className="font-bold text-brand-dark text-sm mb-1">Periksa kembali jawaban</h4>
                    <p className="text-brand-dark/60 text-xs leading-relaxed">Pastikan untuk periksa kembali jawaban sebelum mengirim.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Help Card */}
            <div className="bg-white border border-brand-gray/20 rounded-3xl p-6 shadow-sm flex items-center justify-between cursor-pointer hover:shadow-md transition-shadow">
              <div>
                <h3 className="font-bold text-brand-dark text-base mb-1">Butuh Bantuan?</h3>
                <p className="text-brand-dark/60 text-xs leading-relaxed">
                  Lihat panduan untuk memahami kondisi area sebelum menjawab pertanyaan.
                </p>
              </div>
              <div className="text-brand-gray ml-2">
                &gt;
              </div>
            </div>
      ...
      {showExitModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 px-4">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full text-center shadow-xl">
            <h3 className="text-2xl font-bold text-brand-dark mb-2">Yakin mau balik?</h3>
            <p className="text-brand-dark/70 text-sm mb-8">Perubahan tidak akan disimpan</p>
            <div className="flex gap-4">
              <button 
                onClick={() => setShowExitModal(false)}
                className="flex-1 py-3 rounded-xl border-2 border-brand-orange text-brand-orange font-bold text-sm hover:bg-orange-50 transition-colors"
              >
                Tidak
              </button>
              <button 
                onClick={() => navigate('/cek-kondisi')}
                className="flex-1 py-3 rounded-xl bg-brand-orange text-white font-bold text-sm hover:bg-[#e87f2e] transition-colors"
              >
                Balik
              </button>
            </div>
      ...
      {showResetModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 px-4">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full text-center shadow-xl">
            <h3 className="text-2xl font-bold text-brand-dark mb-2">Ulang dari Awal?</h3>
            <p className="text-brand-dark/70 text-sm mb-8">Riwayat jawaban dan hasil rekomendasi saat ini akan dihapus.</p>
            <div className="flex gap-4">
              <button 
