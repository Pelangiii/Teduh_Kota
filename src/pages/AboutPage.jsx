...
export default function AboutPage() {
  ...
  return (
    ...
    <div className="bg-brand-bg min-h-screen py-20 md:py-28 px-6">
      <div className="max-w-6xl mx-auto space-y-24 md:space-y-32">
        ...
        <div className="bg-white rounded-3xl p-10 md:p-14 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center gap-10">
          <div className="w-36 h-36 bg-brand-card rounded-full flex items-center justify-center text-6xl shrink-0">
            🪴
          </div>
        ...
        <div className="bg-white rounded-3xl p-10 md:p-14 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="text-7xl p-6 bg-brand-card rounded-3xl shrink-0">🌳</div>
        </div>
        ...
        <div className="bg-brand-card rounded-3xl p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8 shadow-sm my-8">
          ...
          <button className="bg-brand-orange hover:bg-brand-orange text-white px-8 py-4 rounded-2xl font-medium text-base transition flex items-center gap-3 whitespace-nowrap shadow-sm shrink-0">
