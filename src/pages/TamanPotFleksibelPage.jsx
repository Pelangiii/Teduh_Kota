...
import warnTamanPotImg from '../assets/images/warn-taman-pot.svg';
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="w-full">
                ...
                <ul className="list-disc pl-5 text-brand-dark/80 text-sm md:text-base space-y-2 font-medium">
                  ...
                  <li>Tanaman hias, herbal, atau sayuran sederhana.</li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="w-full">
                ...
                <ol className="list-decimal pl-5 text-brand-dark/80 text-sm md:text-base space-y-2 font-medium">
                  ...
                  <li>Susun pot tanpa menghalangi jalan.</li>
                  <li>Periksa kelembapan media sebelum menyiram.</li>
                </ol>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex-shrink-0 flex justify-center w-full md:w-auto">
                <img src={warnTamanPotImg} alt="Peringatan Taman Pot" className="w-40 md:w-48 h-auto object-contain" />
              </div>
            </motion.div>
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              >
                <iframe
                  width="100%"
                  height="100%"
                  src="https://www.youtube.com/embed/royDTfMYG-E"
