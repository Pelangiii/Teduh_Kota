...
// Import Assets
import tamanResapanImg from '../assets/images/taman-resapan.svg';
...
import warnTamanResapanImg from '../assets/images/warn-taman-resapan.svg';
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="w-full">
                ...
                <ul className="list-disc pl-5 text-brand-dark/80 dark:text-gray-300 text-sm md:text-base space-y-2 font-medium">
                  ...
                  <li>Lokasi yang aman dari fondasi dan utilitas.</li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="w-full">
                ...
                <ol className="list-decimal pl-5 text-brand-dark/80 dark:text-gray-300 text-sm md:text-base space-y-2 font-medium">
                  ...
                  <li>Siapkan media dan tanaman yang sesuai.</li>
                  <li>Sediakan jalur luapan untuk hujan yang lebih besar.</li>
                </ol>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex-shrink-0 flex justify-center w-full md:w-auto">
                <img src={warnTamanResapanImg} alt="Peringatan Taman Resapan" className="w-40 md:w-48 h-auto object-contain" />
              </div>
            </motion.div>
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              >
                <iframe 
                  width="100%" 
                  height="100%" 
                  src="https://www.youtube.com/embed/WLVLvtZvXys" 
