          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              <p className="text-sm text-gray-500 font-medium dark:text-gray-300">
                Terima kasih telah mendaftar dengan email <span className="font-semibold text-brand-orange dark:text-brand-green">{email}</span>. Kami akan mengirimkan update terbaru untukmu.
              </p>
