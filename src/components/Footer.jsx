        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 px-6 relative z-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              {/* Facebook */}
              <span className="w-8 h-8 rounded-full bg-brand-gray/20 flex items-center justify-center cursor-pointer hover:bg-[#1877F2] text-[#1877F2] hover:text-white transition">
              ...
              {/* Instagram */}
              <span className="w-8 h-8 rounded-full bg-brand-gray/20 flex items-center justify-center cursor-pointer hover:bg-[#E4405F] text-[#E4405F] hover:text-white transition">
              ...
              {/* Twitter */}
              <span className="w-8 h-8 rounded-full bg-brand-gray/20 flex items-center justify-center cursor-pointer hover:bg-[#1DA1F2] text-[#1DA1F2] hover:text-white transition">
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
              </span>
              {/* LinkedIn */}
              <span className="w-8 h-8 rounded-full bg-brand-gray/20 flex items-center justify-center cursor-pointer hover:bg-[#0A66C2] text-[#0A66C2] hover:text-white transition">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-brand-dark font-medium">
              <li><a href="#home" className="hover:text-brand-green transition">Home</a></li>
              <li><a href="#about" className="hover:text-brand-green transition">About</a></li>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <input 
                ...
                className="w-full bg-white border border-brand-orange rounded-xl px-3 py-2 text-xs placeholder:text-brand-light-orange focus:outline-none focus:ring-1 focus:ring-brand-orange text-brand-dark font-medium"
              />
