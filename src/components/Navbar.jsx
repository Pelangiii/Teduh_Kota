...
export default function Navbar() {
  ...
  const isActive = (path) => location.pathname === path || (path === '/beranda' && location.pathname === '/');
    ...
    <header className="w-full bg-white dark:bg-mode-dark sticky top-0 z-50 shadow-xs font-sans transition-colors duration-300 border-b border-gray-100 dark:border-line-dark">
      <nav className="max-w-7xl mx-auto px-8 lg:px-16 py-4 md:py-5 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-8 font-medium text-gray-600 dark:text-gray-300 text-base">
          <Link
            to="/beranda"
            className={`transition ${isActive('/beranda') ? 'text-brand-green font-semibold border-b-2 border-brand-green pb-0.5' : 'hover:text-brand-green dark:hover:text-brand-green'}`}>
            Beranda
          </Link>
          ...
          <motion.div
            ...
            <div className="px-6 py-5 space-y-3 text-base font-medium text-gray-700 dark:text-gray-200">
              <Link
                to="/beranda"
                onClick={closeMenu}
                className={`block py-2.5 px-3 rounded-xl transition-all ${isActive('/beranda')
              ...
              <Link
                to="/tentang"
                onClick={closeMenu}
                className={`block py-2.5 px-3 rounded-xl transition-all ${isActive('/tentang')
                  ? 'text-brand-green bg-brand-green/10 dark:bg-brand-green/20 font-semibold'
                  : 'hover:text-brand-green dark:hover:text-brand-green hover:bg-gray-50 dark:hover:bg-gray-800/50'
                  }`}>
                Tentang
              ...
              <Link
                to="/cek-kondisi"
                onClick={closeMenu}
                className={`block py-2.5 px-3 rounded-xl transition-all ${isActive('/cek-kondisi')
                  ? 'text-brand-green bg-brand-green/10 dark:bg-brand-green/20 font-semibold'
                  : 'hover:text-brand-green dark:hover:text-brand-green hover:bg-gray-50 dark:hover:bg-gray-800/50'
                  }`}>
                Cek Kondisi
              ...
              <Link
                to="/solusi-teduh"
                onClick={closeMenu}
                className={`block py-2.5 px-3 rounded-xl transition-all ${isActive('/solusi-teduh')
                  ? 'text-brand-green bg-brand-green/10 dark:bg-brand-green/20 font-semibold'
                  : 'hover:text-brand-green dark:hover:text-brand-green hover:bg-gray-50 dark:hover:bg-gray-800/50'
                  }`}>
                Solusi Teduh
