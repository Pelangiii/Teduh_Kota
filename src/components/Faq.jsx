...
export default function Faq() {
  ...
  return (
    <div className="w-full dark:bg-mode-dark relative overflow-hidden py-16 md:py-20 transition-colors duration-300">
      ...
      <motion.section
        ...
        <div className="text-center space-y-4 relative z-10 max-w-xl mx-auto">
          ...
          <h2 className="font-header text-3xl md:text-4xl font-normal dark:text-white">
            Masih Ada <span className="text-brand-green font-normal">Pertanyaan?</span>
          </h2>
          <p className="font-sans dark:text-gray-300 text-base">Teduh Kota hadir untuk membantu kamu menemukan solusi yang tepat.</p>
        </div>
        ...
        <div className="space-y-5 relative z-10">
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                key={index}
                className={`rounded-3xl border transition-all duration-300 ${isOpen ? 'bg-brand-green/10 dark:bg-brand-green/20 border-brand-green/30' : 'bg-white dark:bg-card-dark-mode border-gray-100 dark:border-line-dark shadow-card hover:shadow-md'
                  }`}>
                <button
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    <motion.div
                      ...
                      <div className="px-6 md:px-8 pb-8 pt-0 font-sans text-sm md:text-base dark:text-gray-300 leading-relaxed pl-23 md:pl-28">
                        {faq.a}
                      </div>
                    </motion.div>
                  )}
