    ...
    <section className="bg-brand-bg py-16 px-8">
      <div className="max-w-5xl mx-auto bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="w-full md:w-1/3 flex justify-center">
          <div className="w-48 h-48 bg-brand-card rounded-full flex items-center justify-center relative">
        ...
        <div className="w-full md:w-2/3 space-y-4">
          ...
          <div className="pt-2">
            <button className="bg-brand-orange hover:bg-brand-orange text-white px-6 py-2.5 rounded-xl font-medium flex items-center gap-2 transition text-sm">
