...
const file = path.join(__dirname, 'src', 'utils', 'recommendationEngine.js');

const code = `import { SOLUTIONS, WEIGHTS, FIT_MATRIX } from '../data/recommendationConfig.js';
...
console.log("Rewritten engine file");
